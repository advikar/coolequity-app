> **History.** This is the `README.md` of the `contra-costa` branch of [advikar/coolequity](https://github.com/advikar/coolequity/tree/contra-costa), carried over unchanged when the cities were combined into this repository (September 12, 2026). Paths, branch names, run and deploy instructions in it refer to that repository; the top-level README.md is current.
